...
const urls = {
  ...
  buttonLeft2: process.env.PUBLIC_URL + '/images/img_btn_left2.png',
  buttonRight2: process.env.PUBLIC_URL + '/images/img_btn_right2.png',
  buttonCenter2: process.env.PUBLIC_URL + '/images/img_btn_center2.png',
  ...
  character7: process.env.PUBLIC_URL + '/images/img_char_7.gif',
  character8: process.env.PUBLIC_URL + '/images/img_char_8.gif',
  character9: process.env.PUBLIC_URL + '/images/img_char_9.gif',
  character10: process.env.PUBLIC_URL + '/images/img_char_10.png',
  character11: process.env.PUBLIC_URL + '/images/img_char_11.gif',
  character12: process.env.PUBLIC_URL + '/images/img_char_12.gif',
  tree: process.env.PUBLIC_URL + '/images/img_tree.png',
  characterStone: process.env.PUBLIC_URL + '/images/img_stone.gif',
  chest: process.env.PUBLIC_URL + '/images/img_chest.png',
  chest2: process.env.PUBLIC_URL + '/images/img_chest2.png',
  chest3: process.env.PUBLIC_URL + '/images/img_chest3.png',
  gem: process.env.PUBLIC_URL + '/images/img_gem.png',
  gems: process.env.PUBLIC_URL + '/images/img_gems.png',
  gemBox: process.env.PUBLIC_URL + '/images/img_gem_box.png',
  potion: process.env.PUBLIC_URL + '/images/img_potion.png',
